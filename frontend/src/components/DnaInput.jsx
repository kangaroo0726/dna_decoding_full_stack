...
export function DnaInput({ strand, setStrand, strandType, setStrandType, fiveToThree, setFiveToThree }) {
  ...
  <div className="dna-input">
    <textarea id="sequence" aria-label="Sequence" className="text-input" placeholder="Enter sequence" onChange={ (event) => setStrand(event.target.value) } value={ strand }></textarea>
